<nav x-data="{ open: false }" class="border-b border-gray-100 dark:border-gray-700" style="background-color:#03989E">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-slot name="content">
                    <x-dropdown-link :href="route('checksupport')" :active="request()->routeIs('checksupport')">
                        {{ __('Demande de Support') }}
                    </x-dropdown-link>
                    <x-dropdown-link :href="route('verifyressource')" :active="request()->routeIs('verifyressource')">
                        {{ __('Vérification des ressources') }}
                    </x-dropdown-link>
                    </x-slot>
                        </x-dropdown>
                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('verifyressource')" :active="request()->routeIs('verifyressource')">
                {{ __('Vérification des ressources') }}
            </x-responsive-nav-link>
            @endif
        </div>
